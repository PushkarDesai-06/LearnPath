...
- **Assessment**: a batch quiz of MCQs spread across 5 difficulty bands, generated
  in one call and graded together; the level estimate is the highest _contiguously
  passed_ band. A second refinement round is offered only when results look noisy
